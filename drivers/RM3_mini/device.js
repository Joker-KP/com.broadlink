	...
	async onCapabilityLearnIR(onoff) {
		...
		try {
			...
			if (data) {
				...
				await this.setCapabilityValue('learnIRcmd', false); // Turn off the capability after success
				this.learn = false;
				return true;
			} else {
				await this.setCapabilityValue('learnIRcmd', false); // Turn off the capability after failure
				this.learn = false;
				return false;
			}
		} catch (e) {
			await this.setCapabilityValue('learnIRcmd', false); // Turn off the capability after error
